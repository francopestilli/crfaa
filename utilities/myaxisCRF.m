...
function [xphyaxis yphyaxis] = myaxisCRF

if ~(strcmp(get(gca,'xscale'),'log') && strcmp(get(gca,'yscale'),'linear'))
...
xticks.minor = [.0021875 .004375 .00875 .0175 .035 .07 .14 .28 .56 .84 1];
xticks.minortick = xticks.minor;
xticks.major = xticks.minor;
xticks.majortick = xticks.minor;
...
if i == length(xticks.major) % do not plot 1
  xphyaxis.ticks.labels{i} = '';
 else
  xphyaxis.ticks.labels{i} = num2str(100*xticks.major(i));
 end
end
...
yticks.minor = [.25 .5 .75 1 1.25];
yticks.minortick = [.25 .5 .75 1 1.25];
yticks.major = [.25 .5 .75 1 1.25];
yticks.majortick = [.25 .5 .75 1 1.25];
