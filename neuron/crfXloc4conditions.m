function d = crfXloc4conditions(d,location)
% function d = crfXloc4conditions(d,location)
%
...
disp(sprintf('[crfXloc4conditions: LOC%s] Pedestal contrasts: %s',num2str(location),num2str(pedestals)));
...
%             disp(sprintf('[crfXloc4conditions: LOC%s] Attended       - Scan: %s Trial: %s Contrast: %0.4f deltaC: %0.4f PedNum: %s hdrNum: %s',num2str(location),num2str(runNum),num2str(tNum),thisContrast,deltaC,num2str(pedNum),num2str(conditionNum)));
...
%             disp(sprintf('[crfXloc4conditions: LOC%s] Unattended     - Scan: %s Trial: %s Contrast: %0.4f deltaC: %0.4f PedNum: %s hdrNum: %s',num2str(location),num2str(runNum),num2str(tNum),thisContrast,deltaC,num2str(pedNum),num2str(conditionNum)));
...
%             disp(sprintf('[crfXloc4conditions: LOC%s] Distributed  T - Scan: %s Trial: %s Contrast: %0.4f deltaC: %0.4f PedNum: %s hdrNum: %s',num2str(location),num2str(runNum),num2str(tNum),thisContrast,deltaC,num2str(pedNum),num2str(conditionNum)));
...
%             disp(sprintf('[crfXloc4conditions: LOC%s] Distributed NT - Scan: %s Trial: %s Contrast: %0.4f deltaC: %0.4f PedNum: %s hdrNum: %s',num2str(location),num2str(runNum),num2str(tNum),thisContrast,deltaC,num2str(pedNum),num2str(conditionNum)));
        else

            thisContrast = e{runNum}(phaseNum).traces(location,tNum);
            disp(sprintf('[crfXloc4conditions: LOC%s] ERROR NO MATCH FOR THIS VOLUME! -Scan: %s Trial: %s Contrast: %0.4f deltaC: %0.4f PedNum: %s hdrNum: %s',num2str(location),num2str(runNum),num2str(tNum),thisContrast,deltaC,num2str(pedNum),num2str(conditionNum)));
            keyboard
        end
    ...
    disp(sprintf('[crfXloc4conditions: LOC%i] volumes sorted out for SCAN%i',location,runNum));
end
